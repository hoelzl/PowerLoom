...
// Version: PLJTextArea.java,v 1.5 2010/02/04 05:18:29 hans Exp
...
public class PLJTextArea extends JTextArea implements PLClipboardOwner {
    protected PLClipboardOwnerSupport support;

    public PLJTextArea (PLFrame parent, String name, List types) {
	super();
