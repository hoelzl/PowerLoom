...
// Version: ConceptChooserDialog.java,v 1.5 2010/02/04 05:16:50 hans Exp
...
/**
 * Choose to select a concept from a list of concepts.
 * @since 4/2/2002 6:56:42 PM
 * @author <a href=mailto:eric@metrotech-consulting.com>Eric Melz</a>
 */
public class ConceptChooserDialog extends ChooserDialog {
    private ChooserPanel ivjChooserPanel1 = null;
    private javax.swing.JPanel ivjJDialogContentPane = null;
    /**
     * ConceptChooserDialog constructor comment.
     */
    public ConceptChooserDialog() {
	super();
	initialize();
    }
    /**
     ...
     */
    public ConceptChooserDialog(java.awt.Dialog owner) {
	super(owner);
    }
    /**
     * ConceptChooserDialog constructor comment.
     ...
     */
    public ConceptChooserDialog(java.awt.Dialog owner, String title) {
	super(owner, title);
    }
    /**
     * ConceptChooserDialog constructor comment.
     ...
     * @param modal boolean
     */
    public ConceptChooserDialog(java.awt.Dialog owner, String title, boolean modal) {
     ...
     * @param modal boolean
     */
    public ConceptChooserDialog(java.awt.Dialog owner, boolean modal) {
	super(owner, modal);
    }
    /**
     * ConceptChooserDialog constructor comment.
     ...
     */
    public ConceptChooserDialog(java.awt.Frame owner) {
	super(owner);
    }
    /**
     * ConceptChooserDialog constructor comment.
     ...
     * @param title java.lang.String
     */
    public ConceptChooserDialog(java.awt.Frame owner, String title) {
	super(owner, title);
    }
    /**
     * ConceptChooserDialog constructor comment.
     ...
     * @param modal boolean
     */
    public ConceptChooserDialog(java.awt.Frame owner, String title, boolean modal) {
	super(owner, title, modal);
    }
    /**
     * ConceptChooserDialog constructor comment.
     ...
     * @param modal boolean
     */
    public ConceptChooserDialog(java.awt.Frame owner, boolean modal) {
	super(owner, modal);
    }
    /**
