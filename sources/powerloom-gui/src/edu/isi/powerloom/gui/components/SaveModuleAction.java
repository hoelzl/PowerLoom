...
// Version: SaveModuleAction.java,v 1.6 2010/04/19 20:11:00 hans Exp
...
/**
 * Action for saving a module.
 *
 * @author <a href=mailto:eric@metrotech-consulting.com>Eric Melz</a>
 * @since Tue Apr 09 13:52:07 2002
 */
public class SaveModuleAction extends PowerloomAction {
    public SaveModuleAction() {
	super();
	putValue(Action.NAME, "Save Module");
    }
    public SaveModuleAction(PowerloomApp app) {
	super();
	parentApp = app;
	updateActionName();
    }
	...
	//PLRemoteFileBrowser fileBrowser = new PLRemoteFileBrowser(parentApp, module);
	//fileBrowser.showSaveKBDialog();
    }

    public void updateActionName() {
	if (parentApp.getMostRecentlyTouchedObject() != null) {
	    putValue(Action.NAME, "Save " + parentApp.getMostRecentlyTouchedObject() + " Remotely");
	} else {
	    putValue(Action.NAME, "Save Module");
	} 
    }
