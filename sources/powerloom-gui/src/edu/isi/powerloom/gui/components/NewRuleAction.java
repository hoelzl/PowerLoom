...
// Version: NewRuleAction.java,v 1.4 2010/02/04 05:18:14 hans Exp
...
public class NewRuleAction extends NewPropositionAction {
    public NewRuleAction() {
	super();
	putValue(Action.NAME, "Create New Rule");
	putValue(Action.SMALL_ICON, PowerloomApp.getInstance().getImage("resources/images/add.gif"));
    }
    public NewRuleAction(PowerloomApp app) {
	super(app);
    }
}
