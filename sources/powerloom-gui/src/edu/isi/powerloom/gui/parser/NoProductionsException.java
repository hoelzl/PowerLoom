...
// Version: NoProductionsException.java,v 1.3 2010/02/04 05:20:00 hans Exp
...
public class NoProductionsException extends ParseException {
    ...
    public NoProductionsException (String msg){
        super(msg);
    }

    public NoProductionsException(Symbol stackSymbol, Symbol inputSymbol) {
        super("No Productions");
    ...
    public String toString() {
        return "No Productions Found for: StackTop = " + stackSymbol + ", Input = " + inputSymbol;
    }
}
