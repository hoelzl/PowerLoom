...
// Version: PLModuleContainer.java,v 1.4 2010/02/04 05:20:51 hans Exp
 ...
 */
public class PLModuleContainer extends XMLObject implements PLContainer {
    static int count = 0;
    ...
    public Class getContaineeClass() {
        return PLModule.class;
    }
    public String getID() {
        return "PLModuleContainer" + count++;
    }
